      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex flex-col gap-4 bg-gray-800 p-6 rounded-xl shadow-lg w-full md:w-80">
          ...
          <div className="flex justify-between items-center">
            <span>Status:</span>
            <span
              className={`font-bold ${status.includes('Checkmate') ? 'text-red-400' : 'text-green-400'}`}
            >
              {status || 'Playing...'}
            </span>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-bold capitalize">
              {game.turn() === 'w' ? 'White (You)' : 'Black (Stockfish)'}
            </span>
          </div>
          ...
          <div className="mt-4 p-4 bg-gray-700/50 rounded-lg border border-gray-600">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Stuck? Ask Stockfish for the perfect move. You have <strong>{hintsLeft}</strong> hints
              remaining.
            </p>
            <button
              onClick={getHint}
